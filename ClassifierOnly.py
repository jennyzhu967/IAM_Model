...
weights_path = "C:/Users/ericz/OneDrive/Desktop/IAM Model/Models/08_handwriting_recognition_torch/GoldenChild/model.pt"
pre_trained_network.load_state_dict(torch.load(weights_path))
# print(f"Before Pre Classifier: {pre_trained_network.output}")
...
chess_network.fineTune(feature_extract=True) # Turn of gradient tracking (freeze the layers)
# Debugging Code:
# for x in chess_network.pretrained:
#     print(f"Parameters: \n {list(x.parameters())}")
