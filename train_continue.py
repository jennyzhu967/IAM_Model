...
train_path = "C:/Users/ericz/OneDrive/Desktop/IAM Model/Models/08_handwriting_recognition_torch/ClassifierOnly/train.csv"
df_train = pd.read_csv("C:/Users/ericz/OneDrive/Desktop/IAM Model/Models/08_handwriting_recognition_torch/ClassifierOnly/train.csv").values.tolist()

test_path = "C:/Users/ericz/OneDrive/Desktop/IAM Model/Models/08_handwriting_recognition_torch/ClassifierOnly/val.csv"
df_test = pd.read_csv("C:/Users/ericz/OneDrive/Desktop/IAM Model/Models/08_handwriting_recognition_torch/ClassifierOnly/val.csv").values.tolist()
...
pre_trained_network.fineTune(feature_extract=False) # Turn of gradient tracking (freeze the layers)
# Debugging Code:
